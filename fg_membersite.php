...
class FGMembersite
{
	...
	function elec2()
    {
        return isset($_SESSION['ele2'])?$_SESSION['ele2']:'';
    }
	function elec3()
    {
        return isset($_SESSION['ele3'])?$_SESSION['ele3']:'';
    }
    ...
    function InsertIntoDB(&$formvars)
    {
        ...
        $insert_query = 'insert into '.$this->tablename.'(
                ...
                "' . $confirmcode . '",
				"' . $this->SanitizeForSQL($formvars['feereceipt']) . '",
				"' . $this->SanitizeForSQL($formvars['bankname']) . '",
				"' . $this->SanitizeForSQL($formvars['cgpa']) . '"
                )';      
